...
title Batch United OS 1.0 - Alpha 1
...
if exist batbox.exe==Echo Ok
if not exist batbox.exe=goto BSOD1
echo.

echo Insertbmp.exe:
ping localhost -n 2 >nul
if exist insertbmp.exe==Echo Ok
if not exist insertbmp.exe==Goto BSOD2
echo.

echo Bg.exe:
ping localhost -n 2 >nul
if exist bg.exe==Echo Ok
if not exist bg.exe==goto BSOD3
echo.

echo Cmdmenusel.exe:
ping localhost -n 2 >nul
if exist cmdmenusel.exe==Echo Ok
if not exist Cmdmenusel.exe==Goto BSOD4
echo.
...
insertbmp /p:"img\log\smiley.bmp" /x:410 /y:210 /z:100
...
insertbmp /p:"img\tools\lynx.bmp" /x:640 /y:40 /z:100
...
rem Lynx cfg
if %x% equ 80 if %y% equ 3 goto :Lynx
if %x% equ 80 if %y% equ 4 goto :Lynx
if %x% equ 80 if %y% equ 5 goto :Lynx
if %x% equ 80 if %y% equ 6 goto :Lynx
if %x% equ 80 if %y% equ 7 goto :Lynx
if %x% equ 80 if %y% equ 8 goto :Lynx
if %x% equ 81 if %y% equ 3 goto :Lynx
if %x% equ 81 if %y% equ 4 goto :Lynx
if %x% equ 81 if %y% equ 5 goto :Lynx
if %x% equ 81 if %y% equ 6 goto :Lynx
if %x% equ 81 if %y% equ 7 goto :Lynx
if %x% equ 81 if %y% equ 8 goto :Lynx
if %x% equ 82 if %y% equ 3 goto :Lynx
if %x% equ 82 if %y% equ 4 goto :Lynx
if %x% equ 82 if %y% equ 5 goto :Lynx
if %x% equ 82 if %y% equ 6 goto :Lynx
if %x% equ 82 if %y% equ 7 goto :Lynx
if %x% equ 82 if %y% equ 8 goto :Lynx
if %x% equ 83 if %y% equ 3 goto :Lynx
if %x% equ 83 if %y% equ 4 goto :Lynx
if %x% equ 83 if %y% equ 5 goto :Lynx
if %x% equ 83 if %y% equ 6 goto :Lynx
if %x% equ 83 if %y% equ 7 goto :Lynx
if %x% equ 83 if %y% equ 8 goto :Lynx
if %x% equ 84 if %y% equ 3 goto :Lynx
if %x% equ 84 if %y% equ 4 goto :Lynx
if %x% equ 84 if %y% equ 5 goto :Lynx
if %x% equ 84 if %y% equ 6 goto :Lynx
if %x% equ 84 if %y% equ 7 goto :Lynx
if %x% equ 84 if %y% equ 8 goto :Lynx
if %x% equ 85 if %y% equ 3 goto :Lynx
if %x% equ 85 if %y% equ 4 goto :Lynx
if %x% equ 85 if %y% equ 5 goto :Lynx
if %x% equ 85 if %y% equ 6 goto :Lynx
if %x% equ 85 if %y% equ 7 goto :Lynx
if %x% equ 85 if %y% equ 8 goto :Lynx
if %x% equ 86 if %y% equ 3 goto :Lynx
if %x% equ 86 if %y% equ 4 goto :Lynx
if %x% equ 86 if %y% equ 5 goto :Lynx
if %x% equ 86 if %y% equ 6 goto :Lynx
if %x% equ 86 if %y% equ 7 goto :Lynx
if %x% equ 86 if %y% equ 8 goto :Lynx
if %x% equ 87 if %y% equ 3 goto :Lynx
if %x% equ 87 if %y% equ 4 goto :Lynx
if %x% equ 87 if %y% equ 5 goto :Lynx
if %x% equ 87 if %y% equ 6 goto :Lynx
if %x% equ 87 if %y% equ 7 goto :Lynx
if %x% equ 87 if %y% equ 8 goto :Lynx
goto :desktop
...
cls
echo.
echo Shutting down BatchUnited 1.0.0 ...
...
batbox /g 0 2 /c 0x07 /d ""
insertbmp /p:"img\upbarsetting.bmp" /x:0 /y:0 /z:100
cmdMenuSel f8%f0 "<< Go back" "Las Vegas" "Paris" "Pekin"
if %ERRORLEVEL% == 1 goto :bcksetall
if %ERRORLEVEL% == 2 goto :lvback
if %ERRORLEVEL% == 3 goto :psback
if %ERRORLEVEL% == 4 goto :peback
